...
#ifndef OHMYTUNNEL_CHACHA20_H
#define OHMYTUNNEL_CHACHA20_H
...
/*
 *
 * From https://github.com/983/ChaCha20
 *
 */

class Chacha20 : public BaseCodec
{
public:
	Chacha20() : BaseCodec("chacha20")
	{}
...
#define CHACHA20_QUARTERROUND(x, a, b, c, d) \
	...
	struct Chacha20Codec
	{
		...
		Chacha20Codec(const uint8_t key[32], const uint8_t nonce[8], uint64_t counter = 0) : block(key, nonce),
																							 position(64)
		{
